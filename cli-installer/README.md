...
npx career-superskills --bundle career -y
```
...
npx career-superskills --search "research"
```
...
- Claude Cowork updates are manual by design: generate the zip, remove the previous `career-superskills` plugin in Cowork, then upload the new zip.
