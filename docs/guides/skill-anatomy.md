...
This guide explains how skills are structured in the current `career-superskills` architecture and what makes a skill compatible with the supported AI platforms.
