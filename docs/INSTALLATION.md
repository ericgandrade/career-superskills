...
```bash
wget -qO- https://raw.githubusercontent.com/ericgandrade/career-superskills/main/scripts/install.sh | bash
```
...
- ✅ Install career-superskills globally via npm
...
```bash
curl -fsSL https://raw.githubusercontent.com/ericgandrade/career-superskills/main/scripts/install.sh | bash -s -- --yes
```

**With options:**
```bash
# Skip Node.js version check
curl -fsSL https://raw.githubusercontent.com/ericgandrade/career-superskills/main/scripts/install.sh | bash -s -- --skip-node-check

# Verbose output
curl -fsSL https://raw.githubusercontent.com/ericgandrade/career-superskills/main/scripts/install.sh | bash -s -- --verbose

# Help
curl -fsSL https://raw.githubusercontent.com/ericgandrade/career-superskills/main/scripts/install.sh | bash -s -- --help
```
...
```bash
git clone https://github.com/ericgandrade/career-superskills.git
cd career-superskills/cli-installer
npm link
```
...
**Unlink:**
```bash
npm unlink -g career-superskills
```
...
- it generates a zip under `~/.career-superskills/plugin-output/`
...
1. Open `Cowork`.
2. Open `Customize`.
3. Find the installed `career-superskills` plugin.
...
### Issue: "career-superskills: command not found" after install
...
bash <(curl -fsSL https://raw.githubusercontent.com/ericgandrade/career-superskills/main/scripts/install.sh)

# Or download and run
curl -fsSL https://raw.githubusercontent.com/ericgandrade/career-superskills/main/scripts/install.sh -o install.sh
chmod +x install.sh
./install.sh
```
...
2. After installing, run `npx career-superskills` again
...
```bash
# Reinstall
npx career-superskills --all -y

# Or use doctor command to diagnose
npx career-superskills doctor
```
...
cd ~/.codex/skills
ln -s /path/to/career-superskills/skills/skill-creator skill-creator
ln -s /path/to/career-superskills/skills/prompt-engineer prompt-engineer
ln -s /path/to/career-superskills/skills/youtube-summarizer youtube-summarizer
ln -s /path/to/career-superskills/skills/audio-transcriber audio-transcriber
```

---
   - **Claude Code:** https://code.claude.ai/
   
2. Run `career-superskills` again - it will detect the tools
...
**Remove npm package:**
```bash
npm uninstall -g career-superskills
```
...
```bash
npm update -g career-superskills
```
...
- **GitHub Repository:** https://github.com/ericgandrade/career-superskills
- **NPM Package:** https://npmjs.com/package/career-superskills
- **Issues:** https://github.com/ericgandrade/career-superskills/issues
- **Changelog:** https://github.com/ericgandrade/career-superskills/blob/main/cli-installer/CHANGELOG.md
...
1. Check existing issues: https://github.com/ericgandrade/career-superskills/issues
