...
**Installation:**
```bash
npx career-superskills --bundle planning -y
```
...
**Installation:**
```bash
npx career-superskills --bundle research -y
```
...
**Installation:**
```bash
npx career-superskills --bundle obsidian -y
```
...
npx career-superskills install youtube-summarizer -y
...
npx career-superskills install skill-creator

# Install multiple skills
npx career-superskills install skill-creator prompt-engineer youtube-summarizer

# Install with flags
npx career-superskills i skill-creator -a -y -q
```
...
```bash
npx career-superskills --list-bundles
```
